      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-semibold">NexusAI</h3>
            <p className="text-gray-300 max-w-xs">
              Transforming enterprises with cutting-edge AI solutions that drive efficiency and innovation.
            </p>
          </div>
          
          <div className="space-y-4">
            <h4 className="font-medium text-lg">Solutions</h4>
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">AI Analytics</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Intelligent Automation</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Predictive Insights</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Custom AI Development</a></li>
            </ul>
          </div>
